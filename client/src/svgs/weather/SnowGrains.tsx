const SnowGrainsSvg = ({ size }: { size: number } & React.SVGProps<SVGSVGElement>) => {
  return (
    <svg
    ...
    >
      ...
      <path
        fill='#72b8d4'
        d='M23.4 49.6c.7-.9.5-2.2-.4-2.9-.9-.7-2.2-.5-2.9.4-.7.9-.5 2.2.4 2.9.9.7 2.2.5 2.9-.4zM44.9 49.6c.7-.9.5-2.2-.4-2.9-.9-.7-2.2-.5-2.9.4-.6.9-.5 2.2.4 2.9.9.7 2.2.5 2.9-.4z'
      />
      <path
        fill='#ffffff'
