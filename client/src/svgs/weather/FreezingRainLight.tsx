const FreezingRainLight = ({ size }: { size: number } & React.SVGProps<SVGSVGElement>) => {
  return (
    <svg
    ...
    >
      ...
      <path
        fill='#72b8d4'
        d='M26.6 46c-.2 0-.3 0-.5-.1-.5-.3-.7-.9-.5-1.4l3.5-6.6c.3-.5.9-.7 1.4-.5.5.3.7.9.5 1.4l-3.5 6.6c-.1.4-.5.6-.9.6zM31.2 53c-.2 0-.3 0-.5-.1-.5-.3-.7-.9-.5-1.4l6.9-13.7c.3-.5.9-.7 1.4-.5.5.3.7.9.5 1.4l-6.9 13.7c-.1.4-.5.6-.9.6zM26.1 50.6l-2.8 1-.9-2.8 2.8-.9zM27.12 55.65l2.75-.917.918 2.75-2.75.92z'
      />
    </svg>
  );
};

export default FreezingRainLight;
